...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoieGljb2FndWlhciIsImEiOiJja2sxb3Myb3gwcjc2Mm9uamR5eTdyb2Q5In0.Z5mhQIcO3nqPEsZAj94e2A';
  ...
  locations.forEach(function (loc) {
    var el = document.createElement('div'); // create the marker
...
var stripe = Stripe('pk_test_51IBre8CbcVaB34NuvEfi0JDpEwJY04K4jJ7p6q7sb3ZNeESxVikztONX1JKNgZIbclWT2n4b1fbH8agnBQpnATpE00tWS8qm9t');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); //2) Create checkou form + charge credit card
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  var tourId = e.target.dataset.tourId; // (data-tour-id=`${tour.id}`) -> o Id foi passado pelo pug
